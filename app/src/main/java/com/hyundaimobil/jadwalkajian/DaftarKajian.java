...
import static com.hyundaimobil.jadwalkajian.R.id.tanggal;

public class DaftarKajian extends AppCompatActivity {

    private List<ModalTaskKajian> modalTaskList = new ArrayList<>();
    private RecyclerView recyclerView;
    private TaskAdapterKajian mAdapter;
    private String JSON_STRING, kd_masjid, kd_wilayah, wilayah, link_maps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_kajian);
        ...
        link_maps       = intent.getStringExtra(Config.DISP_LINK_MAPS);

        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(Config.CEK_KONEKSI(DaftarKajian.this)) {
                    //Intent intent = new Intent(DaftarKajian.this, DaftarMasjidMaps.class);
                    ...
                    //Snackbar.make(view, link_maps, Snackbar.LENGTH_LONG).setAction("Action", null).show();

                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(link_maps));
        ...
        txtDate     = (TextView) findViewById(tanggal);
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(DaftarKajian.this);
...
//        imagePopup.setWindowWidth(800);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(DaftarKajian.this,
            ...
            public void onLongClick(View view, int position) {
                //ModalTaskKajian modalTask = modalTaskList.get(position);
                //Toast.makeText(DaftarMasjid.this, modalTask.getKode() + " is selected!", Toast.LENGTH_SHORT).show();
                //Toast.makeText(DaftarKajian.this, "Jadwal Kajian Belum Diinput", Toast.LENGTH_SHORT).show();
            }
        }));
    ...
    private void getJSON_showMasjid(){
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(DaftarKajian.this, "", Config.ALERT_PLEASE_WAIT, false, false);
            }
